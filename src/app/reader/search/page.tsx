...
//           <label className="mb-1 text-sm font-medium">Tác giả</label>
...
//         <div className="flex min-w-[160px] flex-1 flex-col">
//           <label className="mb-1 text-sm font-medium">Thể loại</label>
...
//         <div className="flex min-w-[160px] flex-1 flex-col">
//           <label className="mb-1 text-sm font-medium">Kệ sách</label>
...
//         <div className="flex min-w-[160px] flex-1 flex-col">
//           <label className="mb-1 text-sm font-medium">Nhà xuất bản</label>
...
//         <div className="flex min-w-[160px] flex-1 flex-col">
//           <label className="mb-1 text-sm font-medium">Tình trạng</label>
//           <Select
...
//         <div className="flex min-w-[160px] flex-1 flex-col">
//           <label className="mb-1 text-sm font-medium">Sắp xếp theo</label>
...
//       <p>Tổng số {filteredBooks.length} đầu sách</p>

//       <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
//         {currentBooks.map((book, index) => (
//           <div
//             key={index}
//             className="group transform cursor-pointer overflow-hidden rounded-xl border bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
