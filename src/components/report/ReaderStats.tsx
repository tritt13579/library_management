...
// import { startOfToday, subDays, format, differenceInYears } from "date-fns";
...
//   const toISO = useCallback((d: Date) => format(d, "yyyy-MM-dd"), []);
...
//   // Tối ưu monthly stats với single batch query
...
//       // Single query cho tất cả new readers trong 12 tháng
//       const [newReadersResult, activeReadersResult] = await Promise.all([
//         supabase
//           .from("librarycard")
//           .select("issue_date")
//           .gte("issue_date", toISO(startDate))
//           .lt("issue_date", toISO(endDate)),

//         supabase
//           .from("loantransaction")
//           .select("transaction_date, librarycard!inner(reader_id)")
//           .gte("transaction_date", toISO(startDate))
//           .lt("transaction_date", toISO(endDate)),
//       ]);

//       // Group data by month in memory thay vì query nhiều lần
//       const monthlyData: {
...
//         monthlyData[monthKey] = { newReaders: 0, activeReaders: new Set() };
//       }

//       // Process new readers
//       newReadersResult.data?.forEach((card: any) => {
//         const monthKey = format(new Date(card.issue_date), "MM/yyyy");
//         if (monthlyData[monthKey]) {
//           monthlyData[monthKey].newReaders++;
//         }
//       });
...
//           if (readerId) {
//             monthlyData[monthKey].activeReaders.add(readerId);
//           }
//         }
//       });
...
//       try {
//         // Sử dụng RPC hoặc stored procedure nếu có thể để giảm network calls
//         const [
//           totalReadersResult,
//           newReadersResult,
//           activeReadersResult,
...
//           // 3. Độc giả hoạt động - tối ưu query với limit nếu cần
//           supabase
//             .from("loantransaction")
...
//     // Debounce để tránh gọi API quá nhiều khi user thay đổi date range
//     const timeoutId = setTimeout(fetchStats, 300);
//     return () => clearTimeout(timeoutId);
//   }, [dateRange.from, dateRange.to, getAgeGroup, fetchMonthlyStats, toISO]);
...
//         {
//           label: "Độc giả mới",
//           data: stats.monthlyStats.map((item) => item.newReaders),
//           backgroundColor: "rgba(54, 162, 235, 0.7)",
//         },
//         {
//           label: "Độc giả hoạt động",
//           data: stats.monthlyStats.map((item) => item.activeReaders),
...
//         <Card>
//           <CardHeader>
//             <CardTitle>Tổng số độc giả</CardTitle>
//           </CardHeader>
//           <CardContent>
...
//         <Card>
//           <CardHeader>
//             <CardTitle>Độc giả mới</CardTitle>
//           </CardHeader>
//           <CardContent>
...
//         <Card>
//           <CardHeader>
//             <CardTitle>Độc giả hoạt động</CardTitle>
//           </CardHeader>
//           <CardContent>
//             <div className="text-2xl font-bold">
...
//         <Card>
//           <CardHeader>
//             <CardTitle>Thống kê độc giả theo tháng</CardTitle>
//           </CardHeader>
//           <CardContent>
//             <div style={{ height: "300px" }}>
